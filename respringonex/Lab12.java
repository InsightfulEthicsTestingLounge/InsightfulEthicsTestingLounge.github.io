// Lab12st.java
// This is the student, starting file of Lab 12 which draws a title page and 3 flags.
...
public class Lab12 extends Applet
{
	...
	public static void flagOfItaly (Graphics g)
	{
        ...
        public static void flagOfRomainia (Graphics g)
        {
            Expo.setBackground(g,Expo.black);
		for (int d = 1; d <= numDots; d++)
		{
       ...
       public static void flagOfHolland (Graphics g)
      {
		...
		for (int d = 1; d <= numDots; d++)
		{
			...
			if (y < 216)                       // left stripe
				Expo.setColor(g,Expo.red);

			if (y >= 216 && y < 420)		   // middle stripe requires compound condition
				Expo.setColor(g,Expo.white);

			if (y >= 650)                      // right stripe
				Expo.setColor(g,Expo.blue);
